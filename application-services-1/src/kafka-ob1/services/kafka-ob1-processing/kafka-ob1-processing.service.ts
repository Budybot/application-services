...
import { sayHello } from './functions/sayHello.function'; // Import the function
    ...
    async processRequest(message: OB1MessageValue, context: KafkaContext) {
        ...
        try {
            ...
            if (functionName === 'sayHello') {
                return await sayHello(functionInput, instanceName, userEmail); // Call the external function
            }
